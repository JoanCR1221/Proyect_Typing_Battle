...
|---|---|---|---|---|
| 1 | Cómo notifica el juego el fin de partida a Matchmaking | Equipos 2, 4, 5 y 6 | — | Por abrir |
| 2 | Convención de Module Federation entre el Shell y los juegos | Equipos 3, 4, 5 y 6 | — | Por abrir |
| 3 | Autenticación y autorización en la API y el hub de cada juego | Equipos 1, 3, 4, 5 y 6 | — | Por abrir |
